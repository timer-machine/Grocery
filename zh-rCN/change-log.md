...
- 新增: 在特定条件下跳过步骤的跳过提醒
- 新增: 在计时运行页面新增了屏幕亮度设置的菜单项
- 新增: 开源许可证
- 新增: 法语翻译。感谢J. Lavoie和Christian Gallioz！
- 新增: 意大利语翻译。感谢@NiaJ3oE2LM、@anicetus-duck和Giovanni Fortezze！
- 新增: 俄语翻译。感谢@D-iva、v1s7和@Xapitonov！
- 优化: 编辑后保持已启用的计划任务处于启用状态
- 修复: 取消导出时应用删除非空备份文件的问题
- 修复: 屏幕亮度设置在画中画模式下失效的问题
- 修复: 配置变更或进程终止后计时运行页面变白的问题
- 修复: 过半和倒数提醒在中断步骤中失效的问题
...
- 新增: 图片的提醒方式
- 新增: 葡萄牙语翻译。感谢@aescouto, @profmarcos, @cairobraga和大家！
- 优化: 更直观的导入和导出界面
- 修复: 启用文字转语音缓存后朗读和音乐无法同时使用的问题
...
- 新增: Android 14的支持
- 新增: 屏幕提醒方式的全屏颜色将和步骤颜色一致
- 修复: 选择音乐时的一个崩溃
- 修改: “总是全屏”的屏幕提醒方式选项在Android 14上因失效而被移除

## 2024年1月11日 7.4.0

- 新增: 可以提升文字转语音性能的缓存设置选项
- 新增: 荷兰语翻译。感谢Stephan Paternotte！
- 新增: 使用嘟嘟作为倒数提示音的选项
- 修复: 计时器编辑页面的键盘未被及时收起的问题
- 修复: 可以复制起始步骤的问题
